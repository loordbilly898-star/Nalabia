...
import { Infinity as InfinityIcon, Zap, ShieldAlert, Brain, Target, ArrowRight, Star, Crown, MessageCircle, ChevronRight, ChevronLeft, Camera, ThermometerSnowflake, Ghost, Repeat2, Bolt, Feather } from 'lucide-react';
...
const SLIDES = [
  {
    ...
    subtitle: 'O primeiro sistema operacional projetado exclusivamente para otimizar suas interações sociais, decifrar intenções e gerar respostas magnéticas.',
    icon: InfinityIcon,
  ...
  },
  {
    ...
    subtitle: 'Mais do que um chat. Um ecossistema completo para qualquer situação.',
    icon: Target,
    grid: [
      { icon: Camera, title: 'Story Reply', desc: 'Aberturas infalíveis baseadas em imagens.' },
      { icon: Zap, title: 'Flowing', desc: 'Mantenha a conversa fluindo infinitamente.' },
      { icon: ShieldAlert, title: 'Teste de Valor', desc: 'Inverta o jogo quando for testado.' },
      { icon: ThermometerSnowflake, title: 'Resposta Fria', desc: 'Recupere seu poder e postura.' }
    ]
  },
  {
    id: 'personas',
    title: 'Escolha Sua Persona',
    subtitle: 'Adapte a IA ao seu estilo. Respostas perfeitamente calibradas para a imagem que você quer passar.',
    icon: Crown,
    grid: [
      { icon: Feather, title: 'Calmo', desc: 'Misterioso, contido e seguro de si.' },
      { icon: Zap, title: 'Irônico', desc: 'Divertido, provocador e imprevisível.' },
      { icon: Crown, title: 'Dominante', desc: 'Direto, líder e inabalável.' },
      { icon: Bolt, title: 'Ousado', desc: 'Arriscado, polarizador e magnético.' }
    ]
  },
  {
    id: 'cta',
