...
const QUESTIONS = [
  {
    ...
    options: [
      ...
      {
        value: "desenvolver presença social",
        label: "Desenvolver presença social",
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        value: "recuperar conversa perdida",
        label: "Recuperar conversa perdida",
      },
    ],
  },
];
...
export const OnboardingView: React.FC<OnboardingViewProps> = ({
  ...
  const [step, setStep] = useState<"presentation" | "questionnaire">(
    "presentation",
  );
