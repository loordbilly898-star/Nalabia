  ...
  return (
    <>
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="text-center py-4 border-y border-white/5">
              ...
              <div className="text-4xl font-black text-white flex items-center justify-center gap-1">
                <span className="text-lg text-gray-500">R$</span> 19
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full py-4 rounded-xl font-bold text-lg transition-all duration-300 flex items-center justify-center gap-2 bg-red-600 hover:bg-red-700 text-white shadow-[0_0_20px_rgba(220,38,38,0.3)] hover:scale-[1.02]"
              >
                <Lock size={18} />
                Desbloquear Dark Pack (R$ 19,90)
              </button>
      ...
      <StripeCheckoutModal
        ...
        planId="dark"
        planTitle="Modo +18 & DarkPack"
        planPrice="R$ 19,90 (Pagamento Único)"
        planDescription="Acesso vitalício aos modos NSFW e Manipulação"
        onSuccess={() => {
